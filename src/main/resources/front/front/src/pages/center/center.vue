    ...
    <el-tabs tab-position="left" :style='{"border":"1px solid #ddd","width":"100%","padding":"30px 20px","margin":"20px auto 0 auto","borderRadius":"16px","background":"#fff"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,244,218,1) 0%, rgba(254,244,218,1) 51%, rgba(255,234,178,1) 51%, rgba(255,234,178,1) 100%)"}' v-if="userTableName=='yonghu'" label="联系方式" prop="lianxifangshi">
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,244,218,1) 0%, rgba(254,244,218,1) 51%, rgba(255,234,178,1) 51%, rgba(255,234,178,1) 100%)"}' v-if="userTableName=='yonghu'" label="房屋号">
            <el-select v-model="sessionForm.fangwuhao" placeholder="请选择房屋号" >
              <el-option v-for="(item, index) in dynamicProp.fangwuhao" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.sessionForm, 'fangwuhao', null);
      }
    ...
    methods: {
      init() {
        ...
        if ('yonghu' == this.userTableName) {
          this.$http.get('option/fangwuxinxi/fangwuhao', {emulateJSON: true}).then(res => {
            if (res.data.code == 0) {
              this.dynamicProp.fangwuhao = res.data.data;
            }
          });
        }
      },
