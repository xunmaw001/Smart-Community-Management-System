<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20221117/4028956d321c4de892a3b7bc9df13600.jpg) no-repeat","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"30px 100px 80px 80px","boxShadow":"inset 0px 0px 90px 0px #f8ebd5,0 2px 6px #9c7c45","margin":"0","borderColor":"#ffa100","borderRadius":"20% 40%","background":"url() no-repeat center bottom,#fff","borderWidth":"4px","width":"auto","minWidth":"800px","borderStyle":"solid double solid double","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"0 0 24px 0","fontSize":"20px","color":"#ffa100","textAlign":"center","fontWeight":"bold"}'>基于SpringBoot的智慧社区管理系统的设计与实现注册</p></div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 24px","height":"auto"}' v-if="tableName=='yonghu'" prop="lianxifangshi">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 24px","height":"auto"}' v-if="tableName=='yonghu'" prop="fangwuhao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>房屋号：</div>
                <el-select v-model="registerForm.fangwuhao" placeholder="请选择房屋号" >
                  <el-option
                      v-for="(item,index) in yonghufangwuhaoOptions"
                      :key="index"
                      :label="item"
                      :value="item">
                  </el-option>
...
export default {
    ...
    created() {
      ...
      if ('yonghu' == this.tableName) {
        ...
        this.$http({
          url: `option/fangwuxinxi/fangwuhao`,
          method: "get",
          params: {}
        }).then(({ data }) => {
          if (data && data.code === 0) {
              this.yonghufangwuhaoOptions = data.data;
          }
        });
    },
    //方法集合
