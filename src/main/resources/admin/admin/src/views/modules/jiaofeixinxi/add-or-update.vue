	...
	<div class="addEdit-block" :style='{"padding":"30px 5%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="缴费标题" prop="jiaofeibiaoti">
					<el-input v-model="ruleForm.jiaofeibiaoti" placeholder="缴费标题" clearable  :readonly="ro.jiaofeibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="缴费标题" prop="jiaofeibiaoti">
					<el-input v-model="ruleForm.jiaofeibiaoti" placeholder="缴费标题" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'" label="用户账号" prop="yonghuzhanghao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.yonghuzhanghao" label="用户账号" prop="yonghuzhanghao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="缴费清单" prop="jiaofeiqingdan">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.jiaofeiqingdan" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.jiaofeiqingdan" label="缴费清单" prop="jiaofeiqingdan">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiaofeiqingdan"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiaofeibiaoti'){
							this.ruleForm.jiaofeibiaoti = obj[o];
							this.ro.jiaofeibiaoti = true;
							continue;
						}
						if(o=='dengjishijian'){
						...
						if(o=='jiaofeiqingdan'){
							this.ruleForm.jiaofeiqingdan = obj[o];
							this.ro.jiaofeiqingdan = true;
							continue;
						}
						if(o=='yonghuzhanghao'){
			...
			yonghuzhanghaoChange () {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						if(data.data.fangwuhao){
							this.ruleForm.fangwuhao = data.data.fangwuhao
						}
					} else {
						this.$message.error(data.msg);
					}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiaofeiqingdan = this.ruleForm.jiaofeiqingdan.replace(reg,'../../../springboot2p760/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
