<template>
	<div class="addEdit-block" :style='{"padding":"30px 5%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="反馈编号" prop="fankuibianhao">
					<el-input v-model="ruleForm.fankuibianhao" placeholder="反馈编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.fankuibianhao" label="反馈编号" prop="fankuibianhao">
					<el-input v-model="ruleForm.fankuibianhao" placeholder="反馈编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="反馈名称" prop="fankuimingcheng">
					<el-input v-model="ruleForm.fankuimingcheng" placeholder="反馈名称" clearable  :readonly="ro.fankuimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="反馈名称" prop="fankuimingcheng">
					<el-input v-model="ruleForm.fankuimingcheng" placeholder="反馈名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="反馈时间" prop="fankuishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.fankuishijian" label="反馈时间" prop="fankuishijian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="反馈内容" prop="fankuineirong">
					<editor 
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.fankuineirong" label="反馈内容" prop="fankuineirong">
...
export default {
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.fangwuhao!=''&&json.fangwuhao) || json.fangwuhao==0) && this.$storage.get("role")!="管理员"){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fankuineirong = this.ruleForm.fankuineirong.replace(reg,'../../../springboot2p760/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fankuiyijian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fankuiyijianCrossAddOrUpdateFlag = false;
						 this.parent.search();
