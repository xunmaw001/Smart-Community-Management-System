  ...
  <div :style='{"padding":"30px 5%"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}'   v-if="flag=='yonghu'"  label="联系方式" prop="lianxifangshi">
        ...
        <el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="flag=='yonghu'"  label="房屋号" prop="fangwuhao">
