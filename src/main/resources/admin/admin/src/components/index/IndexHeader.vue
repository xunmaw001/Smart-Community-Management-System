<template>
	<div class="navbar">
		<div class="title" :style='{"fontWeight":"600","display":"block"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"18px","color":"rgba(5, 5, 5, 1)","float":"left"}'>{{this.$project.projectName}}</span>
		</div>
