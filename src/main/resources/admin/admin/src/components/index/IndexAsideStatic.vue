<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"20px 0 20px 0","background":"#FFF","width":"180px","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","overflow":"hidden","borderRadius":"15px","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  white-space: nowrap;
				  				  width: 180px;
				  				  background-image: url(http://codegen.caihongy.cn/20220723/ff2ae1bd505548269a186d1cbb798bf4.png);
				  				  position: relative;
				  				  text-align: center;
				  		}
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						...
						background-size: cover;
						color: #000;
						background-image: url(http://codegen.caihongy.cn/20220723/569c7641bf20440ca20c7c09c92036e9.png);
					}
